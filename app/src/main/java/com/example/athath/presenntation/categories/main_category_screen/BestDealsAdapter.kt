...
import com.example.athath.databinding.BestDealsRvItemBinding
import com.example.athath.databinding.SpecialRvItemBinding

class BestDealsAdapter : RecyclerView.Adapter<BestDealsAdapter.BestDealsItemViewHolder>() {

    inner class BestDealsItemViewHolder(private val binding: BestDealsRvItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BestDealsItemViewHolder {
        return BestDealsItemViewHolder(
    ...
    override fun onBindViewHolder(holder: BestDealsItemViewHolder, position: Int) {
